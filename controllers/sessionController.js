...
export const sendSessionEmail = async (req, res) => {
  try {
    ...
    if (!session.email)
      return res.status(400).json({ message: "Email not available for this session" });
    ...
    await sendEmailWithTemplate({
      ...
      templateKey: "2518b.554b0da719bc314.k1.e6bab700-cc33-11f0-8d20-ae9c7e0b6a9f.19ac991e670",
      mergeInfo,
    });
